 ...
 * or record loops other than the one suggested above. For example, you could
 ...
 * Two encoders with the same ID can record compatible streams.
 ...
 *       with NULL data. The user can still send NULL data to the public record
 ...
 * can use this AVCodecContext to decode/record video/audio data.
 *
